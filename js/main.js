...
const manualZones = [
  // North America
  { name: "Pacific Time", latMin: 30, latMax: 50, lonMin: -130, lonMax: -115, offset: -8, label: "PST" },
  { name: "Mountain Time", latMin: 30, latMax: 50, lonMin: -115, lonMax: -100, offset: -7, label: "MST" },
  { name: "Central Time", latMin: 30, latMax: 50, lonMin: -100, lonMax: -85, offset: -6, label: "CST" },
  { name: "Eastern Time", latMin: 30, latMax: 50, lonMin: -85, lonMax: -65, offset: -5, label: "EST" },
  ...
  // Russia (general zones)
  { name: "Russia West", latMin: 50, latMax: 65, lonMin: 30, lonMax: 60, offset: 3, label: "MSK" },
  { name: "Russia Central", latMin: 50, latMax: 65, lonMin: 60, lonMax: 90, offset: 6, label: "OMST" },
  { name: "Russia East", latMin: 50, latMax: 65, lonMin: 90, lonMax: 130, offset: 9, label: "YAKT" },
...
.then(data => {
    ...
    data.forEach(d => {  //convert from string to number
      ...
      const localDate = new Date(utcDate.getTime() + tzOffset.offset * 60 * 60 * 1000);
